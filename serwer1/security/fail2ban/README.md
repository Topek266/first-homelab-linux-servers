...
- automatyczne blokowanie IP po zbyt wielu nieudanych próbach logowania do SSH i Apache2
...
## Napotkane problemy 
Tutaj miałem dwa problemy tylko z exit code, które zobacztłem w logach:
1. Brak znaku = przy dwóch opcjach konfigóracji.
Dodałem brakujące znaki

2. Błąd z ignoreip

Przyczyna:
- użycie przecinka zamiast spacji jako oddzielenie między adresami IP

Rozwiązanie:
- Zmiana z ignoreip = 127.0.0.1/8,192.169.66.0/24 na ignoreip = 127.0.0.1/8 192.168.66.0/24
